namespace GuessWordGame
{
    public class LetterGuesser
    {
        ...
        // Не знаю, что лучше, хранить в этом классе кешированную маску, но тогда угаданные буквы, по сути, будут дублироваться, 
        // два места правды получается, либо тянуть в оба метода угаданные буквы, а маску брать на ходу.
